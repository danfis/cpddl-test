...
gen lplan-lazy-add "--lplan lazy --lplan-h add --lplan-out plan.out"
gen lplan-lazy-add-sql "--lplan lazy --lplan-h add --lplan-succ-gen sql --lplan-out plan.out"

gen gplan-astar-blind "--gplan astar --gplan-out plan.out"
gen lplan-astar-blind "--lplan astar --lplan-out plan.out"
gen gplan-astar-max "--gplan astar --glplan-h max --gplan-out plan.out"
gen lplan-astar-max "--lplan astar --lplan-h hmax --lplan-out plan.out"
gen gplan-astar-lmc "--gplan astar --glplan-h lmc --gplan-out plan.out"

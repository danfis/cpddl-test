...
#line 2365 "src/pddl+.cpp"
    break;

  case 24: /* c_reqs: %empty  */
#line 323 "src/pddl+.yacc"
                         { (yyval.t_pddl_req_flag)= 0; }
#line 2371 "src/pddl+.cpp"
    break;
